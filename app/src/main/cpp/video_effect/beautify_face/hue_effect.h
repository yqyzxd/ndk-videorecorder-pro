...
#ifndef NDK_VIDEORECORDER_PRO_HUE_EFFECT_H
#define NDK_VIDEORECORDER_PRO_HUE_EFFECT_H
...
static char* HUE_EFFECT_FRAGMENT_SHADER =
        ...
        "    highp vec4 color   = texture2D(u_Texture, v_Coordinate);                             \n"
        "                                                                                           \n"
        "    // Convert to YIQ                                                                      \n"
...
class HueEffect : public BaseVideoEffect{
public:
    HueEffect();
    virtual ~HueEffect();
...
private:
    GLint uHueAdjustLocation;
};


#endif //NDK_VIDEORECORDER_PRO_HUE_EFFECT_H
